[![CKAN](https://img.shields.io/badge/ckan-2.10-orange.svg?style=flat-square)](https://github.com/ckan/ckan/tree/2.10)
...
7. If dataset is rejected, editor can edit the dataset and submit it for approval again.
